...
describe('EmployeeListComponent', () => {
  ...
  it('should fetch all employees', () => {
    expect(component.allEmployees).toEqual(stubAllEmployees);
  });

  it('should filter employees based on criteria selected', () => {
    ...
    expect(component.allEmployees).toEqual(stubAllEmployees);
    expect(component.filteredEmployees.length).toEqual(4);
  });

  it('should return if all employees are selected', () => {
    expect(component.isAllSelected()).toEqual(false);
  });

  it('should select all employees on clicking select all checkbox', () => {
    component.masterToggle();
    expect(component.selection.selected.length).toEqual(
      stubAllEmployees.length
    );
  ...
  it('should open employee details dialog box on clicking details button', () => {
    matDialog = TestBed.get(MatDialog);

    spyOn(matDialog, 'open').and.callThrough();
    component.showEmployeeDetails(component.allEmployees[1]);

    expect(matDialog.open).toHaveBeenCalled();
  });
});

const stubAllEmployees: Employee[] = [
  {
    name: 'Faydra Eliasen',
